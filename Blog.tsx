  ...
  const featuredArticles = [
    {
      ...
      excerpt:
        "Explore how IoT technology is revolutionizing urban infrastructure, enhancing sustainability, and improving public services.",
      image:
        "https://soracom.io/wp-content/uploads/2022/01/AdobeStock_181088041-scaled.jpeg",
    ...
    },
    {
      ...
      excerpt:
        "Learn the key steps to creating a successful white-label IoT product that you can brand and sell.",
      image:
        "https://iotbusinessnews.com/WordPress/wp-content/uploads/IoT-internet-of-things-planet.jpg",
    ...
    },
    {
      ...
      excerpt:
        "Stay updated on the latest trends in embedded systems and how they impact IoT product development.",
      image:
        "https://media.licdn.com/dms/image/v2/D5612AQHqV0fa_1C0UA/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1687371323163?e=2147483647&v=beta&t=R_MHS5MgOOa4jcnciSBih0z42Rap-i8UWP3G9jEttvQ",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            Welcome to the Purple Techno Solutions Blog, your go-to resource for
            the latest insights, trends, and innovations in IoT, technology, and
            product development.
          </p>
        </motion.div>
            ...
            {featuredArticles.map((article, index) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${article.color} opacity-20`}
                  ></div>
                  <div
                    className={`absolute top-4 left-4 w-10 h-10 bg-gradient-to-r ${article.color} rounded-xl flex items-center justify-center`}
                  >
                ...
                <div className="p-6">
                  <div className="flex items-center space-x-2 mb-3">
                    <span
                      className={`px-3 py-1 bg-gradient-to-r ${article.color} text-white text-xs font-semibold rounded-full`}
                    >
                      {article.category}
                    </span>
                  </div>
        ...
        >
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-2xl mx-auto">
            Discover articles organized by topic to find exactly what you're
            looking for.
          </p>
        ...
        >
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Our blog is regularly updated with new articles, so be sure to check
            back often or subscribe to our newsletter to receive updates
