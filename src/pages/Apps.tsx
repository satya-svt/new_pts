                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      ...
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="bg-gradient-to-r from-white/20 to-white/10 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 border border-white/30"
                      >
                        Learn More
                      </motion.button>
                    </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            >
              ...
              <button className="bg-gradient-to-r from-blue-400 to-cyan-500 text-white px-4 py-2 rounded-lg text-sm font-semibold">
                Join Now
              </button>
            </motion.div>
            ...
            >
              ...
              <button className="bg-gradient-to-r from-green-400 to-emerald-500 text-white px-4 py-2 rounded-lg text-sm font-semibold">
                Get Started
              </button>
            </motion.div>
          </div>
